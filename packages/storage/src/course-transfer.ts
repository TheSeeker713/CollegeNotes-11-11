...
const exportTables = ['study_schedule', 'study_preferences', 'study_attempts', 'study_activities', 'reading_annotations', 'reading_positions', 'material_revisions', 'semantic_chunks', 'derivatives', 'embedding_indexes', 'research_sessions', 'research_sources', 'drafts'] as const;
