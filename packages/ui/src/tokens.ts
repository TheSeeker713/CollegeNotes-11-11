...
export const VARIANTS: Record<VariantKey, SemanticTokens> = {
  'botanical-light': {
    canvas: '#B5AF9A', surface: '#E8E4D6', notes: '#E6EDD9', study: '#F1E1D3', listen: '#DEEAF0', practice: '#E4E8D8', visuals: '#E2E6DC',
  ...
  'botanical-dark': {
    canvas: '#0A1410', surface: '#14241B', notes: '#24362A', study: '#352A25', listen: '#1E3039', practice: '#2A3528', visuals: '#26332A',
  ...
  'brutalist-light': {
    canvas: '#D8D7D1', surface: '#FFFFFF', notes: '#F1F3F7', study: '#E4EBFC', listen: '#E8EBEF', practice: '#EEF0E8', visuals: '#EEF1EA',
  ...
  'brutalist-dark': {
    canvas: '#121212', surface: '#1C1C1E', notes: '#242831', study: '#202C40', listen: '#1C2730', practice: '#222820', visuals: '#222A24',
