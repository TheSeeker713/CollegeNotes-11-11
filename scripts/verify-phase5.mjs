...
if (!['5.1', '5.2', '5.3', '5.4'].includes(phase)) throw new Error('Expected Phase 5 step');
const out = `.local/verification/phase5/${phase}`;
...
const report = { phase, time: new Date().toISOString(), sourceHashes: before, sourceUnchanged, results,
  ownerOnlyPending: ['desktop rendered design review', 'UI/UX manual tests', 'browser/accessibility checks', 'Phase 5 owner acceptance'],
