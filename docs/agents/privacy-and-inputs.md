...
Public source contains application code, specifications and synthetic/redistributable test content only. Keep raw course material, names of classmates, personal recordings, credentials, exact environment details, traces and source reports private. Stage explicit reviewed files; inspect diffs and history candidates. Git is not a backup of private learning data.
